#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""YOLOX 파인튜닝 (CustomTrainModel).

train_eval.main() 의 --model_kind yolox 분기에서 lazy import 된다.
무거운 YOLOX/torch 의존성을 이 모듈에 격리하여, entrypoint(train_eval.py) 가
이들을 eager import 하지 않도록 한다.
"""

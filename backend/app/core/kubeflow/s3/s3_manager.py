...
class S3Manager:
    __instance: Optional["S3Manager"] = None
    ...
    def __init__(self):
        ...
        if not hasattr(self, "initialized"):
            self.endpoint = settings.INNOGRID_OBJECT_STORAGE_ENDPOINT
            self.access_key = settings.INNOGRID_OBJECT_STORAGE_ACCESS_KEY
            self.secret_key = settings.INNOGRID_OBJECT_STORAGE_SECRET_KEY
            self.bucket = settings.INNOGRID_OBJECT_STORAGE_BUCKET
